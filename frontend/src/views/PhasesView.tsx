  ...
  if (lanes.isLoading) {
    return (
      <div className="flex h-full flex-col overflow-hidden">
        <ViewPageHeader tabKey="phases" />
        <div className="p-6 text-sm text-wp-slate">Loading phases…</div>
      </div>
    );
  }
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <ViewPageHeader
        tabKey="phases"
        description={
          "Every card on the board sits in exactly one phase. Admins can edit descriptions in Admin Settings → Swim lanes."
        }
      />
